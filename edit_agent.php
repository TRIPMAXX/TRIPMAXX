										...
										<div class="box-body">
											<div id="" class="row rows">
												<div class="form-group col-md-6">
													...
													<input type="text" class="form-control form_input1 validate[required]" id="company_name" name="company_name" placeholder="Company Name" value="<?php echo(isset($_POST['company_name']) && $_POST['company_name']!='' ? $_POST['company_name'] : (isset($find_sub_agent['company_name']) && $find_sub_agent['company_name']!='' ? $find_sub_agent['company_name'] : ""));?>" tabindex="1">
												</div>
												<div class="form-group col-md-6">
													<label for="accounting_name" class="form-label1">Company Accounting Name <font color="#FF0000">*</font> :</label>
													<input type="text" class="form-control form_input1 validate[required]" id="accounting_name" name="accounting_name" placeholder="Company Accounting Name" value="<?php echo(isset($_POST['accounting_name']) && $_POST['accounting_name']!='' ? $_POST['accounting_name'] : (isset($find_sub_agent['accounting_name']) && $find_sub_agent['accounting_name']!='' ? $find_sub_agent['accounting_name'] : ""));?>" tabindex="2">
												</div>
												<div class="clearfix"></div>
												<div class="form-group col-md-4">
													<label for="first_name" class="form-label1">First Name <font color="#FF0000">*</font> :</label>
													<input type="text" class="form-control form_input1 validate[required]" id="first_name" name="first_name" placeholder="First Name" value="<?php echo(isset($_POST['first_name']) && $_POST['first_name']!='' ? $_POST['first_name'] : (isset($find_sub_agent['first_name']) && $find_sub_agent['first_name']!='' ? $find_sub_agent['first_name'] : ""));?>" tabindex="3">
												</div>
												<div class="form-group col-md-4">
													<label for="middle_name" class="form-label1">Middle Name :</label>
													<input type="text" class="form-control form_input1" id="middle_name" name="middle_name" placeholder="Middle Name" value="<?php echo(isset($_POST['middle_name']) && $_POST['middle_name']!='' ? $_POST['middle_name'] : (isset($find_sub_agent['middle_name']) && $find_sub_agent['middle_name']!='' ? $find_sub_agent['middle_name'] : ""));?>" tabindex="4">
												</div>
														
												<div class="form-group col-md-4">
													<label for="last_name" class="form-label1">Last Name <font color="#FF0000">*</font> :</label>
													<input type="text" class="form-control form_input1 validate[required]" id="last_name" name="last_name" placeholder="Last Name" value="<?php echo(isset($_POST['last_name']) && $_POST['last_name']!='' ? $_POST['last_name'] : (isset($find_sub_agent['last_name']) && $find_sub_agent['last_name']!='' ? $find_sub_agent['last_name'] : ""));?>" tabindex="5">
												</div>
												<div class="clearfix"></div>
												<div class="form-group col-md-6">
													<label for="email_address" class="form-label1">Email <font color="#FF0000">*</font> :</label>
													<input type="email" class="form-control form_input1 validate[required]" id="email_address" name="email_address" placeholder="Email" value="<?php echo(isset($_POST['email_address']) && $_POST['email_address']!='' ? $_POST['email_address'] : (isset($find_sub_agent['email_address']) && $find_sub_agent['email_address']!='' ? $find_sub_agent['email_address'] : ""));?>" tabindex="6">
												</div>
												<div class="form-group col-md-6">
												...
												<div class="form-group col-md-6">
													...
													<input type="text" class="form-control form_input1 validate[required]" id="zipcode" name="zipcode" placeholder="Pincode/Zipcode/Postcode" value="<?php echo(isset($_POST['zipcode']) && $_POST['zipcode']!='' ? $_POST['zipcode'] : (isset($find_sub_agent['zipcode']) && $find_sub_agent['zipcode']!='' ? $find_sub_agent['zipcode'] : ""));?>" tabindex="14">
												</div>
												<div class="clearfix"></div>
												<div class="form-group col-md-12">
													<label for="address" class="form-label1">Address <font color="#FF0000">*</font> :</label>
													<textarea class="form-control form_input1 validate[required]" rows="5" id="address" name="address" tabindex="15"><?php echo(isset($_POST['address']) && $_POST['address']!='' ? $_POST['address'] : (isset($find_sub_agent['address']) && $find_sub_agent['address']!='' ? $find_sub_agent['address'] : ""));?></textarea>
												</div>
												<div class="form-group col-md-6">
												...
												<div class="form-group col-md-6">
													...
													<input type="text" class="form-control form_input1 validate[required]" id="telephone" name="telephone" placeholder="Telephone" value="<?php echo(isset($_POST['telephone']) && $_POST['telephone']!='' ? $_POST['telephone'] : (isset($find_sub_agent['telephone']) && $find_sub_agent['telephone']!='' ? $find_sub_agent['telephone'] : ""));?>" tabindex="17">
												</div>
												<div class="clearfix"></div>
												<div class="form-group col-md-6">
