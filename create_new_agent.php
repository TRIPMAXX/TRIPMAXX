	...
	if(isset($_POST['btn_submit'])) {
		if(tools::verify_token($white_list_array, $_POST, $verify_token)) {
			...
			if(isset($_FILES) && !empty($_FILES))
				$uploaded_file_json_data='{"uploaded_file_data":[{"form_field_name":"image","form_field_name_hidden":"image_hidden","file_path":AGENT_IMAGES,"width":"310","height":"60","file_type":"image"}]}';
									...
									<div class="col-md-12 row rows">
										...
										<div class="box-body">
											<div id="" class="row rows">
												...
												<div class="form-group col-md-4">
													<label for="middle_name" class="form-label1 validate[optional, custom[onlyLetterSp]]">Middle Name :</label>
