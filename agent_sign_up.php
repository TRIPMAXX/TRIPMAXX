				...
				<div id="" class="col-md-12">
					<div id="" class="form_full_width">
						<div id="" class="form_text_wrapper agent_form_text_wrapper">
							<div class="offer-slider-lbl">AGENT SIGNUP</div>
							<p>Connect with us to sell your products & services and to build a long standing mutual business relationship by filling & submitting the form given below. We appreciate your interest and looking forward to build business together. </p>
						</div>
						<div id="" class="form_wrapper agent_form_wrapper">
							<form name="agent_signe_up" id="agent_signe_up" method="POST" enctype="multipart/form-data">
								...
								<div id="" class="row rows">
									...
									<div id="" class="col-md-3">
										<div class="form-group fancy-form">
											<input type="file" class="validate[required]" id="image" name="image" placeholder="Your Logo" tabindex="20">
