...
<html>
<head>
	<title><?php echo(DEFAULT_PAGE_TITLE_CONTROL_CENTER);?>EDIT BOOKING DETAILS</title>
			...
			<section class="content">
				<div class="row">
					<section class="col-lg-12 connectedSortable">
						...
						<div class="box">
							<div class="box-header">
							   <h3 class="box-title">Ordered Rooms</h3>
							</div>
							<div class="box-body">
										...
										<table aria-describedby="example1_info" id="example" class="table table-bordered table-striped dataTable">
											...
											<tbody aria-relevant="all" aria-live="polite" role="alert">
												<tr class="odd">
													...
													<td class=" ">Double Delux Room</td>
													<td class=" ">1</td>
													<td class=" ">3</td>
													<td class=" "><font color = "red"><b>$847.00</b></font></td>
													<td class=" "><font color = "red"><b>$2541.00</b></font></td>
												</tr>
												<tr class="odd">
													<td class=" " colspan = "6" style = "text-align:right;"><b>TOTAL ORDER AMOUNT:</b></td>
													<td class=" " colspan = "1"><font color = "red"><b>$2541.00</b></font></td>
												</tr>
												<tr class="odd">
													<td class=" " colspan = "6" style = "text-align:right;"><b>STATUS:</b></td>
													<td class=" " colspan = "1">
														<select name="status" id="status" class="form-control validate[optional]" tabindex = "1">
												...
												<tr class="odd">
													<td class=" " colspan = "6" style = "text-align:right;"><b>COMMENT:</b></td>
													<td class=" " colspan = "1">
														<textarea name="comment" id="comment" class="form-control validate[optional]"  tabindex = "2"></textarea>
													</td>
												</tr>
												<tr class="odd">
													<td class=" " colspan = "6" style = "text-align:right;">&nbsp;</td>
													<td class=" " colspan = "1">
