								...
								<div id="" class="col-md-12">
									<div id="" class="row">
										...
										<div id="" class="col-md-4">
											<div id="" class="row">
												<a href="<?php echo(DOMAIN_NAME_PATH_HOTEL);?>create_new_room"><button class="status_checks btn btn-success btn-md" type="submit" style="float:right; margin-bottom:10px;" value="" onclick="" >CREATE NEW ROOM</button></a>
											</div>
										</div>
									</div>
								</div>
											...
											<tbody aria-relevant="all" aria-live="polite" role="alert">
												<tr class="odd">
													...
													<td class=" " data-title="Action">
														<a href = "<?php echo(DOMAIN_NAME_PATH_HOTEL);?>edit_room" title = "Edit Rooms"><i class="fa fa-pencil-square-o fa-1x" ></i></a>&nbsp;&nbsp;
