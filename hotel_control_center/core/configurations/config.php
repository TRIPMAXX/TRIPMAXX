...
define("HOTEL_CONTROL_CENTER_CSS_PATH", $website_url.$project_folder."hotel_control_center/assets/css/");

//URL FOR CONTROL CENTER IMAGE
define("HOTEL_CONTROL_CENTER_IMAGE_PATH", $website_url.$project_folder."hotel_control_center/assets/img/");

//URL FOR CONTROL CENTER JS
define("HOTEL_CONTROL_CENTER_JS_PATH", $website_url.$project_folder."hotel_control_center/assets/js/");

//PATH FOR CONTROL CENTER CKEDITOR
define("HOTEL_CONTROL_CENTER_CKEDITOR_PATH", $website_url.$project_folder."hotel_control_center/assets/ckeditor/");

//PATH FOR CONTROL CENTER COMMON FILES
define("HOTEL_CONTROL_CENTER_COMMON_FILE_PATH", "assets/common/");

//DAFAULT PAGE TITLE
define("DEFAULT_PAGE_TITLE", "TRIPMAXX - ");

//DAFAULT PAGE TITLE CONTROL CENTER
define("DEFAULT_PAGE_TITLE_CONTROL_CENTER_HOTEL", "HOTEL CONTROL CENTER - TRIPMAXX - ");
