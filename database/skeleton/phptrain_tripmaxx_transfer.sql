...
--
-- Host: localhost:3306
-- Generation Time: Jun 28, 2018 at 04:01 AM
...
--
-- Database: `phptrain_tripmaxx_transfer`
--
...
CREATE TABLE `tm_offers` (
  ...
  `service_type` text,
  `price_per_person` decimal(10,2) DEFAULT '0.00' COMMENT 'ids of tm_attributes table',
...
--
-- Table structure for table `tm_transfers`
--

CREATE TABLE `tm_transfers` (
  `id` int(11) NOT NULL,
  `transfer_title` varchar(255) DEFAULT NULL,
  `transfer_images` varchar(255) DEFAULT NULL,
  `transfer_service` varchar(255) DEFAULT NULL,
  `service_note` text,
  `country` int(11) NOT NULL DEFAULT '0',
  `state` int(11) NOT NULL DEFAULT '0',
  `city` int(11) NOT NULL DEFAULT '0',
  `allow_pickup_type` text COMMENT 'id from tm_attributes table',
  `allow_dropoff_type` text COMMENT 'id from tm_attributes table',
...
ALTER TABLE `tm_airports`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_name` (`code`,`name`,`cityCode`);
...
--
-- Indexes for table `tm_transfers`
--
ALTER TABLE `tm_transfers`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tm_transfers`
--
ALTER TABLE `tm_transfers`
