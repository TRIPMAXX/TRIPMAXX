...
if(isset($_POST['btn_submit'])) {
	...
	if(tools::verify_token($white_list_array, $_POST, $verify_token)) {
		...
		if(tools::module_data_exists_check("page_heading = '".tools::stripcleantohtml($_POST['page_heading'])."'", '', TM_CMS)) {
			...
			if($save_cms_data = tools::module_form_submission($uploaded_file_json_data, TM_CMS)) {
				...
				$_SESSION['SET_FLASH'] = 'CMS has been created successfully.';
				header("location:cms");
				exit;
			} else {
				$_SESSION['SET_TYPE'] = 'error';
...
<head>
	...
	jQuery(document).ready(function(){
		jQuery("#add_cms").validationEngine();
	});
	</script>
	<!-- JAVASCRIPT CODE -->
</head>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="box box-primary">
							<form role="form" name="add_cms" id="add_cms"method="post" enctype="multipart/form-data">
								<div class="col-md-12 row">
									<div class="box-body">
										<div class="form-group col-md-6">
											<label for="page_heading" class="control-label">Page Heading<font color="#FF0000">*</font></label>
											<input type="text" class="form-control validate[required]"  value="<?php echo(isset($_POST['page_heading']) && $_POST['page_heading']!='' ? $_POST['page_heading'] : "");?>" name="page_heading" id="page_heading" placeholder="Page Heading" tabindex = "1" />
										</div>
										<div class="form-group col-md-6">
											<label for="page_title" class="control-label">Page Title<font color="#FF0000">*</font></label>
											<input type="text" class="form-control validate[required]"  value="<?php echo(isset($_POST['page_title']) && $_POST['page_title']!='' ? $_POST['page_title'] : "");?>" name="page_title" id="page_title" placeholder="Page Title" tabindex = "2" />
										</div>
										<div class="form-group col-md-12">
											<label for="page_description">Page Description</label>
											<textarea class="form-control ckeditor" name="page_description" id="page_description" placeholder="Page Description" tabindex = "3"><?php echo(isset($_POST['page_description']) && $_POST['page_description']!='' ? $_POST['page_description'] : "");?></textarea>
										</div>
										<div class="form-group col-md-12">
										...
										<div class="form-group col-md-12">
											...
											<input type="text" class="form-control"  value="<?php echo(isset($_POST['page_meta_title']) && $_POST['page_meta_title']!='' ? $_POST['page_meta_title'] : "");?>" name="page_meta_title" id="page_meta_title" placeholder="Page Meta Title" tabindex = "5" />
										</div>
										<div class="form-group col-md-6">
											<label for="page_meta_keyword" class="control-label">Page Meta Keyword</label>
											<textarea class="form-control" name="page_meta_keyword" id="page_meta_keyword" placeholder="Page Meta Keyword" tabindex = "6"><?php echo(isset($_POST['page_meta_keyword']) && $_POST['page_meta_keyword']!='' ? $_POST['page_meta_keyword'] : "");?></textarea>
										</div>
										<div class="form-group col-md-6">
											<label for="page_meta_description" class="control-label">Page Meta Description</label>
											<textarea class="form-control" name="page_meta_description" id="page_meta_description" placeholder="Page Meta Description" tabindex = "7"><?php echo(isset($_POST['page_meta_description']) && $_POST['page_meta_description']!='' ? $_POST['page_meta_description'] : "");?></textarea>
										</div>
									</div>
								</div>
								<div class="col-md-12 row">
