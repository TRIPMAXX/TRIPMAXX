				...
				elseif($return_data_arr['status']=="success"):
					...
					if(isset($_POST['btn_submit'])) {
						if(tools::verify_token($white_list_array, $_POST, $verify_token)) {
							...
							curl_setopt($ch, CURLOPT_POSTFIELDS, $post_data_str);
							curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true);
							curl_setopt($ch, CURLOPT_URL, DOMAIN_NAME_PATH.REST_API_PATH.TRANSFER_API_PATH."offer/create.php");
							curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
							$return_data = curl_exec($ch);
							curl_close($ch);
							$return_data_arr=json_decode($return_data, true);
...
<head>
	...
	<!--
	$(function(){
		$("#form_create_transfer_offer").validationEngine();
	});
	//-->
	</script>
	<!-- JAVASCRIPT CODE -->
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
            <section class="content-header">
               <h1>Create New Transfer Offer For "<?php echo(isset($transfer_data['transfer_title']) && $transfer_data['transfer_title']!='' ? $transfer_data['transfer_title'] : "N/A");?>"</h1>
               <ol class="breadcrumb">
            ...
            <section class="content">
				<form name="form_create_transfer_offer" id="form_create_transfer_offer" method="POST" enctype="multipart/form-data">
					<div class="row">
						<div class="col-md-12">
								...
								<div class="col-md-12 row">
									<div class="box-body">
										...
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control validate[required]"  value="<?php echo(isset($_POST['price_per_person']) && $_POST['price_per_person']!='' ? $_POST['price_per_person'] : "");?>" name="price_per_person" id="price_per_person" placeholder="Default Price" tabindex = "4" />
										</div>
										<div class="form-group col-md-6">
