									...
									<div class="box-body">
										...
										<div class="form-group col-md-4">
											...
											<select name = "tour_service" id="tour_service" class="form-control form_input1 select_bg validate[required]" tabindex="6">
												...
												<option value = "Private" <?php echo(isset($_POST['tour_service']) && $_POST['tour_service']=="Private" ? 'selected="selected"' : (isset($tour_data['tour_service']) && $tour_data['tour_service']=="Private" ? 'selected="selected"' : ""));?>>Private</option>
												<option value = "Shared" <?php echo(isset($_POST['tour_service']) && $_POST['tour_service']=="Shared" ? 'selected="selected"' : (isset($tour_data['tour_service']) && $tour_data['tour_service']=="Shared" ? 'selected="selected"' : ""));?>>Shared</option>
											</select>
										</div>
										<div class="form-group col-md-4">
											<label for="service_note" class="control-label">Service Note</label>
											<input type="text" class="form-control"  value="<?php echo(isset($_POST['service_note']) && $_POST['service_note']!='' ? $_POST['service_note'] : (isset($tour_data['service_note']) && $tour_data['service_note']!='' ? $tour_data['service_note'] : ""));?>" name="service_note" id="service_note" placeholder="Service Note" tabindex = "7" />
										</div>
										<div class="form-group col-md-4">
										...
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control"  value="<?php echo(isset($_POST['tour_start_time']) && $_POST['tour_start_time']!='' ? $_POST['tour_start_time'] : (isset($tour_data['tour_start_time']) && $tour_data['tour_start_time']!='' ? $tour_data['tour_start_time'] : ""));?>" name="tour_start_time" id="tour_start_time" placeholder="Tour Start Time" tabindex = "9" />
										</div>
										<div class="form-group col-md-6">
											<label for="tour_end_time" class="control-label">Tour End Time (24 hour format - hh:mm)</label>
											<input type="text" class="form-control"  value="<?php echo(isset($_POST['tour_end_time']) && $_POST['tour_end_time']!='' ? $_POST['tour_end_time'] : (isset($tour_data['tour_end_time']) && $tour_data['tour_end_time']!='' ? $tour_data['tour_end_time'] : ""));?>" name="tour_end_time" id="tour_end_time" placeholder="Tour End Time" tabindex = "10" />
										</div>
										<div class="clearfix"></div>
										<div class="form-group col-md-12">
