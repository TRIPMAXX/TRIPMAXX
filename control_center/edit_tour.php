								...
								<div class="col-md-12 row">
									<div class="box-body">
										...
										<div class="form-group col-md-12">
											<div class = "col-md-3">
												<img src = "<?php echo(CONTROL_CENTER_IMAGE_PATH);?>tour/img1.jpg" border = "0" alt = "" width = "250" height = "150" />
											</div>
											<div class = "col-md-3">
												<img src = "<?php echo(CONTROL_CENTER_IMAGE_PATH);?>tour/img2.jpg" border = "0" alt = "" width = "250" height = "150" />
											</div>
											<div class = "col-md-3">
												<img src = "<?php echo(CONTROL_CENTER_IMAGE_PATH);?>tour/img1.jpg" border = "0" alt = "" width = "250" height = "150" />
											</div>
