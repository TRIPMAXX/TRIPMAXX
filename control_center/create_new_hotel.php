			...
			if(isset($_POST['btn_submit'])) {
				...
				elseif(!isset($_POST['hotel_type_arr'])):
					...
					if(tools::verify_token($white_list_array, $_POST, $verify_token)) {
						...
						curl_setopt($ch, CURLOPT_POSTFIELDS, $post_data_str);
						curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true);
						curl_setopt($ch, CURLOPT_URL, DOMAIN_NAME_PATH.REST_API_PATH.HOTEL_API_PATH."hotel/create.php");
						curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
						$return_data = curl_exec($ch);
						curl_close($ch);
						$return_data_arr=json_decode($return_data, true);
...
<html>
<head>
	<title><?php echo(DEFAULT_PAGE_TITLE_CONTROL_CENTER);?>CREATE NEW HOTEL</title>
	<?php require_once(CONTROL_CENTER_COMMON_FILE_PATH.'meta.php');?>
	<!-- JAVASCRIPT CODE -->
	<script type="text/javascript">
	<!--
	$(function(){
		$("#form_create_hotel").validationEngine();
		...
		<div class="content-wrapper">
            <section class="content-header">
               ...
               <ol class="breadcrumb">
                  ...
                  <li class="active">Create New Hotel</li>
               </ol>
            </section>
							...
							<form name="form_create_hotel" id="form_create_hotel" method="POST" enctype="multipart/form-data">
								<div class="col-md-12 row">
									<div class="box-body">
										...
										<div class="form-group col-md-4">
											...
											<input type="password" class="form-control validate[required]"  value="" name="password" id="password" placeholder="Password" tabindex = "4"/>
										</div>
										<div class="form-group col-md-4">
										...
										<div class="form-group col-md-12">
											...
											<textarea class="form-control ckeditor validate[required]"  value="" name="long_description" id="long_description" placeholder="Long Description" tabindex = "14"><?php echo(isset($_POST['long_description']) && $_POST['long_description']!='' ? $_POST['long_description'] : "");?></textarea>
										</div>
										<div class="form-group col-md-4">
											<label for="checkin_time" class="control-label">Checkin Time (24 hr format - hh:mm)<font color="#FF0000">*</font></label>
											<input type="text" class="form-control validate[required]"  value="<?php echo(isset($_POST['checkin_time']) && $_POST['checkin_time']!='' ? $_POST['checkin_time'] : "");?>" name="checkin_time" id="checkin_time" placeholder="Checkin Time" tabindex = "15" />
										</div>
										<div class="form-group col-md-4">
											<label for="checkout_time" class="control-label">Checkout Time(24 hr format - hh:mm)<font color="#FF0000">*</font></label>
											<input type="text" class="form-control validate[required]"  value="<?php echo(isset($_POST['checkout_time']) && $_POST['checkout_time']!='' ? $_POST['checkout_time'] : "");?>" name="checkout_time" id="checkout_time" placeholder="Checkout Time" tabindex = "16" />
										</div>
										<div class="form-group col-md-4">
											...
											for($i=1;$i<=5;$i++):
											?>
												<option value = "<?= $i;?>" <?php echo(isset($_POST['rating']) && $_POST['rating']==$i ? 'selected="selected"' : "");?>><?= $i;?> Star</option>
											<?php
											endfor;
											?>
											</select>
										...
										<div class="form-group col-md-4">
											...
											<input type="text" class="form-control"  value="<?php echo(isset($_POST['cancellation_charge']) && $_POST['cancellation_charge']!='' ? $_POST['cancellation_charge'] : "");?>" name="cancellation_charge" id="cancellation_charge" placeholder="Cancellation Charge" tabindex = "19" />
										</div>
										<div class="form-group col-md-4">
								...
								<div class="col-md-12 row">
									<div class="box-footer">
										...
										<button type="submit" id="btn_submit" name="btn_submit" class="btn btn-primary" tabindex = "23">CREATE</button>
									</div>
								</div>
							</form>
							<div class="clearfix"></div>
