			...
			if($autentication_data->status=="success"):
				...
				if(isset($_POST['btn_submit'])) {
					...
					if(tools::verify_token($white_list_array, $_POST, $verify_token)) {
						...
						curl_setopt($ch, CURLOPT_URL, DOMAIN_NAME_PATH.REST_API_PATH.HOTEL_API_PATH."room-attribute/update.php");
...
<html>
<head>
	<title><?php echo(DEFAULT_PAGE_TITLE_CONTROL_CENTER);?>EDIT ROOM ATTRIBUTE</title>
	<?php require_once(CONTROL_CENTER_COMMON_FILE_PATH.'meta.php');?>
	<!-- JAVASCRIPT CODE -->
	<script type="text/javascript">
	<!--
	jQuery(document).ready(function(){
		jQuery("#edit_room_attribute_from").validationEngine();
	});
	//-->
	</script>
	<!-- JAVASCRIPT CODE -->
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="box box-primary">
							<form name="edit_room_attribute_from" id="edit_room_attribute_from" method="POST" enctype="multipart/form-data">
