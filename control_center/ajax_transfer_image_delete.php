...
require_once('loader.inc');
	...
	if(isset($_POST['transfer_id']) && $_POST['transfer_id']!="" && isset($_POST['image_name']) && $_POST['image_name']!=""):
		...
		if(isset($autentication_data->status)):
			if($autentication_data->status=="success"):
				...
				curl_setopt($ch, CURLOPT_URL, DOMAIN_NAME_PATH.REST_API_PATH.TRANSFER_API_PATH."transfer/image_delete.php");
