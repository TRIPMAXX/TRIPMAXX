<?php
	...
	$verify_token = "create_new_agent_credit";
				...
				elseif($return_data_arr['status']=="success"):
					...
					if(isset($_POST['btn_submit'])) {
						...
						if(tools::verify_token($white_list_array, $_POST, $verify_token)) {
							...
							curl_setopt($ch, CURLOPT_POSTFIELDS, $post_data_str);
							curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true);
							curl_setopt($ch, CURLOPT_URL, DOMAIN_NAME_PATH.REST_API_PATH.AGENT_API_PATH."accounting/create.php");
							curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
							$return_data = curl_exec($ch);
							curl_close($ch);
							$return_data_arr=json_decode($return_data, true);
...
<html>
  <head>
	...
	<!--
	$(function(){
		$("#form_new_agent_credit").validationEngine();
	});
	//-->
	</script>
	<!-- JAVASCRIPT CODE -->
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>Create New Agent Credit</h1>
				<ol class="breadcrumb">
					<li><a href="<?php echo(DOMAIN_NAME_PATH_ADMIN);?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">Create New Agent Credit</li>
				</ol>
			</section>
            <section class="content">
				<form name="form_new_agent_credit" id="form_new_agent_credit" method="POST" enctype="multipart/form-data">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="box box-primary">
								...
								<div class="box-body">
									<div id="" class="row rows">
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control form_input1 validate[required, custom[number]]" id="amount" name="amount" placeholder="Amount" value="<?php echo(isset($_POST['amount']) && $_POST['amount']!='' ? $_POST['amount'] : "");?>" tabindex="1">
										</div>
										<div class="form-group col-md-12">
											<label for="note" class="form-label1">Notes <font color="#FF0000">*</font> :</label>
											<textarea class="form-control form_input1 validate[required]" rows="5" id="note" name="note" tabindex="2"><?php echo(isset($_POST['note']) && $_POST['note']!='' ? $_POST['note'] : "");?></textarea>
										</div>
							...
							<div class="box-footer">
								...
								<button type="submit" id="btn_submit" name="btn_submit" class="btn btn-primary" tabindex="3">CREATE</button>
							</div>
						</div>
					</div>
				</div>
