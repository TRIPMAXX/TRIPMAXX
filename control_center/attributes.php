										...
										<tbody aria-relevant="all" aria-live="polite" role="alert">
											<tr class="odd">
												...
												<td class=" " data-title="Action">
													<a href = "<?php echo(DOMAIN_NAME_PATH_ADMIN);?>edit_attribute" title = "Edit Attribute"><i class="fa fa-pencil-square-o fa-1x" ></i></a>&nbsp;&nbsp;
