								...
								<div class="col-md-12 row">
									<div class="box-body">
										<div class="form-group col-md-6">
											...
											<select class="form-control" name = "agent_type" id = "agent_type" tabindex = "1">
										...
										<div class="form-group col-md-6">
											...
											<select class="form-control" name = "agents" id = "agents" tabindex = "2">
										...
										<div class="form-group col-md-6">
											...
											<select class="form-control" name = "booking_type" id = "booking_type" tabindex = "3">
												<option value = "A">All</option>
												<option value = "R">Ready Package Booking</option>"
												<option value = "C">Custom Package Booking</option>
											</select>
										</div>
										<div class="form-group col-md-6">
											<label for="email"><font color="#FF0000">*</font>Booking Status</label>
											<select class="form-control" name = "booking_status" id = "booking_status" tabindex = "4">
												<option value = "A">All</option>
										...
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control"  value="" name="date_from" id="date_from" placeholder="Date From" tabindex = "5" />
										</div>
										<div class="form-group col-md-6">
											<label for="inputName" class="control-label">Date To</label>
											<div class="input-icon right">
												<input type="text" class="form-control"  placeholder = "Date To" name="date_to" id="date_to" tabindex = "6" />
											</div>
										</div>
