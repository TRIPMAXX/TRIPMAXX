	...
	if(isset($autentication_data->status)):
		if($autentication_data->status=="success"):
			...
			if(isset($_GET['attribute_id']) && $_GET['attribute_id']!=""):
				...
				curl_setopt($ch, CURLOPT_URL, DOMAIN_NAME_PATH.REST_API_PATH.TOUR_API_PATH."attribute/delete.php");
...
<head>
	...
	{
		$.ajax({
			url:"<?= DOMAIN_NAME_PATH_ADMIN."ajax_tour_attribute_status_update";?>",
			type:"post",
			data:{
										...
										?>
											<tr class="odd">
												...
												<td class=" " data-title="Action">
													<a href = "<?php echo(DOMAIN_NAME_PATH_ADMIN);?>edit_tour_attribute?attribute_id=<?php echo base64_encode($attribute_val['id']);?>" title = "Edit Attribute"><i class="fa fa-pencil-square-o fa-1x" ></i></a>&nbsp;&nbsp;
													<!-- <a href = "<?php echo(DOMAIN_NAME_PATH_ADMIN);?>tour_attributes?attribute_id=<?php echo base64_encode($attribute_val['id']);?>"  title = "Delete Attribute" onclick = "confirm('Are you sure you want to delete this item?') ? '' : event.preventDefault()"><i class="fa fa fa-trash-o fa-1x"></i></a> -->
												</td>
											</tr>
										<?php
											endforeach;
