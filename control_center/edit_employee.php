							...
							<div class="col-md-12 row">
								...
								<div class="box-body">
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control validate[required, custom[onlyLetterSp]]"  value="<?php echo(isset($_POST['first_name']) && $_POST['first_name']!='' ? $_POST['first_name'] : $find_employee['first_name']);?>" name="first_name" id="first_name" placeholder="First Name"  tabindex = "1" />
									</div>
									<div class="form-group col-md-6">
										<label for="last_name"><font color="#FF0000">*</font>Last Name</label>
										<input type="text" class="form-control validate[required, custom[onlyLetterSp]]"  value="<?php echo(isset($_POST['last_name']) && $_POST['last_name']!='' ? $_POST['last_name'] : $find_employee['last_name']);?>" name="last_name" id="last_name" placeholder="Last Name"  tabindex = "2" />
									</div>
									<div class="clearfix"></div>
									<div class="form-group col-md-6">
										<label for="email_address"><font color="#FF0000">*</font>Email</label>
										<input type="text" class="form-control validate[required, custom[email]], custom[email]"  value="<?php echo(isset($_POST['email_address']) && $_POST['email_address']!='' ? $_POST['email_address'] : $find_employee['email_address']);?>" name="email_address" id="email_address" placeholder="Email Address" tabindex = "3" />
									</div>
									<div class="form-group col-md-6">
