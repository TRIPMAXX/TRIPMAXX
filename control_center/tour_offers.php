	...
	if(isset($_GET['tour_id']) && $_GET['tour_id']!=""):
		...
		if(isset($autentication_data->status)):
			if($autentication_data->status=="success"):
				...
				curl_setopt($ch, CURLOPT_URL, DOMAIN_NAME_PATH.REST_API_PATH.TOUR_API_PATH."setting/currency.php");
				...
				elseif($return_data_arr['status']=="success"):
					...
					if(isset($_GET['offer_id']) && $_GET['offer_id']!=""):
						...
						curl_setopt($ch, CURLOPT_HTTPHEADER, array("Accept: application/json, Content-Type: application/json"));
						curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true);
						curl_setopt($ch, CURLOPT_URL, DOMAIN_NAME_PATH.REST_API_PATH.TOUR_API_PATH."offer/delete.php");
						curl_setopt($ch, CURLOPT_POSTFIELDS, $post_data_str);
						curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
						$return_data = curl_exec($ch);
						curl_close($ch);
...
<head>
	...
	{
		$.ajax({
			url:"<?= DOMAIN_NAME_PATH_ADMIN."ajax_tour_offer_status_update";?>",
			type:"post",
			data:{
				offer_id:offer_id,
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>Lists Of Tour Offers For "<?php echo(isset($tour_data['tour_title']) && $tour_data['tour_title']!='' ? $tour_data['tour_title'] : "N/A");?>"</h1>
				<ol class="breadcrumb">
								...
								<div id="" class="col-md-12">
									<div id="" class="row">
										...
										<div id="" class="col-md-4">
											<div id="" class="row">
												<a href="<?php echo(DOMAIN_NAME_PATH_ADMIN);?>create_new_tour_offer?tour_id=<?php echo $_GET['tour_id'];?>"><button class="status_checks btn btn-success btn-md" type="submit" style="float:right; margin-bottom:10px;" value="" onclick="" >CREATE NEW TOUR OFFER</button></a>
											</div>
										</div>
									</div>
								</div>
