			...
			if($autentication_data->status=="success"):
				...
				if(isset($_POST['btn_submit'])) {
					...
					if(tools::verify_token($white_list_array, $_POST, $verify_token)) {
						...
						curl_setopt($ch, CURLOPT_URL, DOMAIN_NAME_PATH.REST_API_PATH.TRANSFER_API_PATH."attribute/update.php");
...
<html>
<head>
	<title><?php echo(DEFAULT_PAGE_TITLE_CONTROL_CENTER);?>EDIT TRANSFER ATTRIBUTE</title>
	<?php require_once(CONTROL_CENTER_COMMON_FILE_PATH.'meta.php');?>
	<!-- JAVASCRIPT CODE -->
	<script type="text/javascript">
	<!--
	$(function(){
		$("#edit_transfer_attributes_form").validationEngine();
	});
	//-->
	</script>
</head>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
            <section class="content-header">
               <h1>Edit Transfer Attribute</h1>
               <ol class="breadcrumb">
                  <li><a href="<?php echo(DOMAIN_NAME_PATH_ADMIN);?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                  <li class="active">Edit Transfer Attribute</li>
               </ol>
            </section>
