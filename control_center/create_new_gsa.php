		...
		if($autentication_data->status=="success"):
			...
			if(isset($_POST['btn_submit'])) {
				if(tools::verify_token($white_list_array, $_POST, $verify_token)) {
					...
					if($return_data_arr['status']=="success")
					{
						$tm_gsa_template = tools::find("first", TM_EMAIL_TEMPLATES, $value='id, template_title, template_subject, template_body, status', "WHERE id=:id AND status=:status ", array(':id'=>19, ':status'=>1));
...
<html>
  <head>
    <title><?php echo(DEFAULT_PAGE_TITLE_CONTROL_CENTER);?>CREATE NEW GSA</title>
	<?php require_once(CONTROL_CENTER_COMMON_FILE_PATH.'meta.php');?>
	<!-- JAVASCRIPT CODE -->
	<script type="text/javascript">
	<!--
	$(function(){
		$("#form_new_gsa").validationEngine();
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>Create New GSA</h1>
				<ol class="breadcrumb">
					<li><a href="<?php echo(DOMAIN_NAME_PATH_ADMIN);?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">Create New GSA</li>
				</ol>
			</section>
            <section class="content">
				<form name="form_new_gsa" id="form_new_gsa" method="POST" enctype="multipart/form-data">
				<div class="row">
					<div class="col-md-12">
									...
									<div id="" class="row rows">
										...
										<div id="" class="col-md-8">
											<div class="row rows">
												<div id="" class="col-md-4">
													<div class="form-group fancy-form">
														<input type="text" class="form-control form_input1 validate[required]" id="account_department_name" name="account_department_name" placeholder="Name" value="<?php echo(isset($_POST['account_department_name']) && $_POST['account_department_name']!='' ? $_POST['account_department_name'] : "");?>" tabindex="25">
													</div>
												</div>
												<div id="" class="col-md-4">
													<div class="form-group fancy-form">
														<input type="email" class="form-control form_input1 validate[required, custom[email]]" id="account_department_email" name="account_department_email" placeholder="Email" value="<?php echo(isset($_POST['account_department_email']) && $_POST['account_department_email']!='' ? $_POST['account_department_email'] : "");?>" tabindex="26">
													</div>
												</div>
												<div id="" class="col-md-4">
													<div class="form-group fancy-form">
														<input type="text" class="form-control form_input1 validate[required]" id="account_department_number" name="account_department_number" placeholder="Contact Number" value="<?php echo(isset($_POST['account_department_number']) && $_POST['account_department_number']!='' ? $_POST['account_department_number'] : "");?>" tabindex="27">
													</div>
												</div>
											</div>
										</div>
										...
										<div id="" class="col-md-8">
											<div class="row rows">
												<div id="" class="col-md-4">
													<div class="form-group fancy-form">
														<input type="text" class="form-control form_input1 validate[required]" id="reservation_department_name" name="reservation_department_name" placeholder="Name" value="<?php echo(isset($_POST['reservation_department_name']) && $_POST['reservation_department_name']!='' ? $_POST['reservation_department_name'] : "");?>" tabindex="28">
													</div>
												</div>
												<div id="" class="col-md-4">
													<div class="form-group fancy-form">
														<input type="email" class="form-control form_input1 validate[required, custom[email]]" id="reservation_department_email" name="reservation_department_email" placeholder="Email" value="<?php echo(isset($_POST['reservation_department_email']) && $_POST['reservation_department_email']!='' ? $_POST['reservation_department_email'] : "");?>" tabindex="29">
													</div>
												</div>
												<div id="" class="col-md-4">
													<div class="form-group fancy-form">
														<input type="text" class="form-control form_input1 validate[required]" id="reservation_department_number" name="reservation_department_number" placeholder="Contact Number" value="<?php echo(isset($_POST['reservation_department_number']) && $_POST['reservation_department_number']!='' ? $_POST['reservation_department_number'] : "");?>" tabindex="30">
													</div>
												</div>
											</div>
										</div>
											...
											<div id="" class="row rows">
												...
												<div id="" class="col-md-8">
													<div class="row rows">
														<div id="" class="col-md-4">
															<div class="form-group fancy-form">
																<input type="text" class="form-control form_input1 validate[required]" id="management_department_name" name="management_department_name" placeholder="Name" value="<?php echo(isset($_POST['management_department_name']) && $_POST['management_department_name']!='' ? $_POST['management_department_name'] : "");?>" tabindex="31">
															</div>
														</div>
														<div id="" class="col-md-4">
															<div class="form-group fancy-form">
																<input type="email" class="form-control form_input1 validate[required, custom[email]]" id="management_department_email" name="management_department_email" placeholder="Email" value="<?php echo(isset($_POST['management_department_email']) && $_POST['management_department_email']!='' ? $_POST['management_department_email'] : "");?>" tabindex="32">
															</div>
														</div>
														<div id="" class="col-md-4">
															<div class="form-group fancy-form">
																<input type="text" class="form-control form_input1 validate[required]" id="management_department_number" name="management_department_number" placeholder="Contact Number" value="<?php echo(isset($_POST['management_department_number']) && $_POST['management_department_number']!='' ? $_POST['management_department_number'] : "");?>" tabindex="33">
															</div>
														</div>
													</div>
												</div>
