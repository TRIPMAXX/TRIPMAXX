									...
									<div id="" class="row rows">
										...
										<div id="" class="col-md-8">
											<div class="row rows">
												...
												<div id="" class="col-md-3">
													<div class="form-group fancy-form">
														<input type="text" class="form-control form_input1 validate[required, custom[onlyLetterSp]]" id="account_department_name" name="account_department_name" placeholder="Name" value="<?php echo(isset($_POST['account_department_name']) && $_POST['account_department_name']!='' ? $_POST['account_department_name'] : "");?>" tabindex="26" readonly>
													</div>
												</div>
												<div id="" class="col-md-3">
													<div class="form-group fancy-form">
										...
										<div id="" class="col-md-8">
											<div class="row rows">
												...
												<div id="" class="col-md-3">
													<div class="form-group fancy-form">
														<input type="text" class="form-control form_input1 validate[required, custom[onlyLetterSp]]" id="reservation_department_name" name="reservation_department_name" placeholder="Name" value="<?php echo(isset($_POST['reservation_department_name']) && $_POST['reservation_department_name']!='' ? $_POST['reservation_department_name'] : "");?>" tabindex="30" readonly>
													</div>
												</div>
												<div id="" class="col-md-3">
													<div class="form-group fancy-form">
												...
												<div id="" class="col-md-3">
													<div class="form-group fancy-form">
														<input type="text" class="form-control form_input1 validate[required, custom[phone]]" id="reservation_department_number" name="reservation_department_number" placeholder="Contact Number" value="<?php echo(isset($_POST['reservation_department_number']) && $_POST['reservation_department_number']!='' ? $_POST['reservation_department_number'] : "");?>" tabindex="32" readonly>
													</div>
												</div>
											</div>
										</div>
											...
											<div id="" class="row rows">
												...
												<div id="" class="col-md-8">
													<div class="row rows">
														...
														<div id="" class="col-md-3">
															<div class="form-group fancy-form">
																<input type="text" class="form-control form_input1 validate[required, custom[phone]]" id="management_department_number" name="management_department_number" placeholder="Contact Number" value="<?php echo(isset($_POST['management_department_number']) && $_POST['management_department_number']!='' ? $_POST['management_department_number'] : "");?>" tabindex="36" readonly>
															</div>
														</div>
													</div>
												</div>
