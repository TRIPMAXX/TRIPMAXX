								...
								<div class="col-md-12 row">
									<div class="box-body">
										...
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control validate[required, custom[onlyLetterNumber]]"  value="<?php echo(isset($_POST['tour_title']) && $_POST['tour_title']!='' ? $_POST['tour_title'] : "");?>" name="tour_title" id="tour_title" placeholder="Tour Title" tabindex = "4" />
										</div>
										<div class="form-group col-md-6">
