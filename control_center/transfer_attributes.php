	...
	if(isset($autentication_data->status)):
		if($autentication_data->status=="success"):
			...
			if(isset($_GET['attribute_id']) && $_GET['attribute_id']!=""):
				...
				curl_setopt($ch, CURLOPT_URL, DOMAIN_NAME_PATH.REST_API_PATH.TRANSFER_API_PATH."attribute/delete.php");
...
<html>
<head>
	<title><?php echo(DEFAULT_PAGE_TITLE_CONTROL_CENTER);?>LISTS OF TRANSFER ATTRIBUTES</title>
	...
	{
		$.ajax({
			url:"<?= DOMAIN_NAME_PATH_ADMIN."ajax_transfer_attribute_status_update";?>",
			type:"post",
			data:{
...
<body class="skin-purple">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>Lists Of Transfer Attributes</h1>
			<ol class="breadcrumb">
				<li><a href="<?php echo(DOMAIN_NAME_PATH_ADMIN);?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
				<li class="active">Lists Of Transfer Attributes </li>
			</ol>
		</section>
											...
											?>
												<tr class="odd">
													...
													<td class=" " data-title="Action">
														<a href = "<?php echo(DOMAIN_NAME_PATH_ADMIN);?>edit_transfer_attribute?attribute_id=<?php echo base64_encode($attribute_val['id']);?>" title = "Edit Attribute"><i class="fa fa-pencil-square-o fa-1x" ></i></a>&nbsp;&nbsp;
														<!-- <a href = "<?php echo(DOMAIN_NAME_PATH_ADMIN);?>transfer_attributes?attribute_id=<?php echo base64_encode($attribute_val['id']);?>"  title = "Delete Attribute" onclick = "confirm('Are you sure you want to delete this item?') ? '' : event.preventDefault()"><i class="fa fa fa-trash-o fa-1x"></i></a> -->
													</td>
												</tr>
											<?php
												endforeach;
