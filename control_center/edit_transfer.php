							...
							<form name="profile" name="form_create_slider" id="form_create_slider" method="POST" enctype="mulimedeia/form-data">
								<div class="col-md-12 row">
									<div class="box-body">
										...
										<div class="form-group col-md-6">
											<label for="inputName" class="control-label">Allowed Pickup Type<font color="#FF0000">*</font></label>
											<select name = "country" class="form-control form_input1 select_bg" multiple>
												<option value = "">Select Pickup Type</option>
												<option value = "Airport">Airport</option>
												<option value = "Accomodation">Accomodation</option>
												<option value = "Port">Port</option>
												<option value = "Port">Station</option>
												<option value = "Port">Others</option>
											</select>
											<br/>
											<font color = "red">Hold Control Key To Select Multiple</font>
										</div>
										<div class="form-group col-md-6">
											<label for="inputName" class="control-label">Allowed Drop-off Type<font color="#FF0000">*</font></label>
											<select name = "country" class="form-control form_input1 select_bg" multiple>
										...
										<div class="form-group col-md-6">
											<label for="inputName" class="control-label">Transfer Title<font color="#FF0000">*</font></label>
										...
										<div class="form-group col-md-6">
											<label for="inputName" class="control-label">Transfer Images<font color="#FF0000">*</font></label>
