								...
								<div class="col-md-12 row">
									<div class="box-body">
										...
										<div class="form-group col-md-4">
											...
											<input type="text" class="form-control validate[required, custom[email]]"  value="<?php echo(isset($_POST['email_address']) && $_POST['email_address']!='' ? $_POST['email_address'] : (isset($hotel_data['email_address']) && $hotel_data['email_address']!='' ? $hotel_data['email_address'] : ""));?>" name="email_address" id="email_address" placeholder="Email Address" tabindex = "3" />
										</div>
										<div class="form-group col-md-4">
