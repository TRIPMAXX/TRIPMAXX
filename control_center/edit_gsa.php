								...
								<div class="box-body">
									<div id="" class="row rows">
										...
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control form_input1 validate[required, custom[onlyLetterNumber]]" id="zipcode" name="zipcode" placeholder="Pincode/Zipcode/Postcode" value="<?php echo(isset($_POST['zipcode']) && $_POST['zipcode']!='' ? $_POST['zipcode'] : (isset($gsa_data['zipcode']) && $gsa_data['zipcode']!='' ? $gsa_data['zipcode'] : ""));?>" tabindex="14">
										</div>
										<div class="clearfix"></div>
