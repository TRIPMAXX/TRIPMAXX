	...
	if(isset($autentication_data->status)):
		if($autentication_data->status=="success"):
			...
			if(isset($_POST['btn_submit'])) {
				$_POST['id']=base64_decode($_GET['gsa_id']);
				if(tools::verify_token($white_list_array, $_POST, $verify_token)) {
					...
					if($return_data_arr['status']=="success")
					{
						if($_POST['password'] != "")
						{
							$tm_gsa_template = tools::find("first", TM_EMAIL_TEMPLATES, $value='id, template_title, template_subject, template_body, status', "WHERE id=:id AND status=:status ", array(':id'=>22, ':status'=>1));
...
<html>
  <head>
    <title><?php echo(DEFAULT_PAGE_TITLE_CONTROL_CENTER);?>EDIT GSA</title>
	<?php require_once(CONTROL_CENTER_COMMON_FILE_PATH.'meta.php');?>
	<!-- JAVASCRIPT CODE -->
	<script type="text/javascript">
	<!--
	$(function(){
		$("#form_edit_gsa").validationEngine();
		// HIDE & SHOW
		...
		<?php 
		if((isset($_POST['country']) && $_POST['country']!="") || (isset($gsa_data['country']) && $gsa_data['country']!=""))
		{
		?>
			fetch_state(<?php echo(isset($_POST['country']) && $_POST['country']!="" ? $_POST['country'] : (isset($gsa_data['country']) && $gsa_data['country']!="" ? $gsa_data['country'] : ""));?>);
		<?php
		}
		?>
		<?php 
		if((isset($_POST['state']) && $_POST['state']!="") || (isset($gsa_data['state']) && $gsa_data['state']!=""))
		{
		?>
			fetch_city(<?php echo(isset($_POST['state']) && $_POST['state']!="" ? $_POST['state'] : (isset($gsa_data['state']) && $gsa_data['state']!="" ? $gsa_data['state'] : ""));?>);
		<?php
		}
		?>
	...
	function fetch_state(country_id)
	{
		$.ajax({
			...
			$("#state").val('<?php echo(isset($_POST['state']) && $_POST['state']!="" ? $_POST['state'] : (isset($gsa_data['state']) && $gsa_data['state']!="" ? $gsa_data['state'] : ""));?>');
		});;
	}
	function fetch_city(state_id)
	{
		$.ajax({
			...
			$("#city").val('<?php echo(isset($_POST['city']) && $_POST['city']!="" ? $_POST['city'] : (isset($gsa_data['city']) && $gsa_data['city']!="" ? $gsa_data['city'] : ""));?>');
		});
	}
	//-->
	</script>
		...
		<div class="content-wrapper">
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Edit GSA</li>
				</ol>
			</section>
            <section class="content">
				<form  name="form_edit_gsa" id="form_edit_gsa" method="POST" enctype="multipart/form-data">
				<div class="row">
					<div class="col-md-12">
								...
								<div class="box-body">
									<div id="" class="row rows">
										...
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control form_input1" id="designation" name="designation" placeholder="Designation" value="<?php echo(isset($_POST['designation']) && $_POST['designation']!='' ? $_POST['designation'] : (isset($gsa_data['designation']) && $gsa_data['designation']!='' ? $gsa_data['designation'] : ""));?>" tabindex="7">
										</div>
										<div class="clearfix"></div>
										<div class="form-group col-md-6 radio_pad">
											...
											<select name="iata_status" id="iata_status" class="form-control form_input1 select_bg" tabindex="8">
												<option value="1" <?php echo(isset($_POST['iata_status']) && $_POST['iata_status']==1 ? 'selected="selected"' : (isset($gsa_data['iata_status']) && $gsa_data['iata_status']==1 ? 'selected="selected"' : ""));?>>Approve</option>
												<option value="0" <?php echo(isset($_POST['iata_status']) && $_POST['iata_status']==0 ? 'selected="selected"' : (isset($gsa_data['iata_status']) && $gsa_data['iata_status']==0 ? 'selected="selected"' : ""));?>>Not Approve</option>
											</select>
										</div>
										<div class="form-group col-md-6">
											...
											<select name="nature_of_business" id="nature_of_business" class="form-control form_input1 select_bg" tabindex="9">
												...
												<option value="Activity Supplier" <?php echo(isset($_POST['nature_of_business']) && $_POST['nature_of_business']=="Activity Supplier" ? 'selected="selected"' : (isset($gsa_data['nature_of_business']) && $gsa_data['nature_of_business']=="Activity Supplier" ? 'selected="selected"' : ""));?>>Activity Supplier</option>
												<option value="Hotel" <?php echo(isset($_POST['nature_of_business']) && $_POST['nature_of_business']=="Hotel" ? 'selected="selected"' : (isset($gsa_data['nature_of_business']) && $gsa_data['nature_of_business']=="Hotel" ? 'selected="selected"' : ""));?>>Hotel</option>
												<option value="Hotel Chain" <?php echo(isset($_POST['nature_of_business']) && $_POST['nature_of_business']=="Hotel Chain" ? 'selected="selected"' : (isset($gsa_data['nature_of_business']) && $gsa_data['nature_of_business']=="Hotel Chain" ? 'selected="selected"' : ""));?>>Hotel Chain</option>
												<option value="Resturent" <?php echo(isset($_POST['nature_of_business']) && $_POST['nature_of_business']=="Resturent" ? 'selected="selected"' : (isset($gsa_data['nature_of_business']) && $gsa_data['nature_of_business']=="Resturent" ? 'selected="selected"' : ""));?>>Resturent</option>
											</select>
										</div>
										<div class="clearfix"></div>
										<div class="form-group col-md-6">
										...
										<div class="form-group col-md-6">
											...
											<select name = "country" id="country" class="form-control form_input1 select_bg validate[required]" tabindex = "11">
												...
												?>
													<option value = "<?php echo $country_val['id'];?>" <?php echo(isset($_POST['country']) && $_POST['country']==$country_val['id'] ? 'selected="selected"' : (isset($gsa_data['country']) && $gsa_data['country']==$country_val['id'] ? 'selected="selected"' : ""));?>><?php echo $country_val['name'];?></option>
												<?php
													endforeach;
												endif;
												?>
										...
										<div class="form-group col-md-6">
											...
											{
											?>
												<option value="<?php echo $time_key;?>" <?php echo(isset($_POST['timezone']) && $_POST['timezone']==$time_key ? "selected='selected'" : (isset($gsa_data['timezone']) && $gsa_data['timezone']==$time_key ? "selected='selected'" : ''))?>><?php echo $time_val;?></option>
											<?php
											}
											?>
											</select>
										...
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control form_input1" id="website" name="website" placeholder="Website" value="<?php echo(isset($_POST['website']) && $_POST['website']!='' ? $_POST['website'] : (isset($gsa_data['website']) && $gsa_data['website']!='' ? $gsa_data['website'] : ""));?>" tabindex="19">
										</div>
										<div class="clearfix"></div>
										<div class="form-group col-md-6">
											...
											<?php
											if(isset($gsa_data['image']) && $gsa_data['image']!=""):
											?>
											<br/>
											<img src = "<?php echo(AGENT_IMAGE_PATH.$gsa_data['image']);?>" border = "0" alt = "" style="width:150px;height:100px;margin:1px;" onerror="this.remove;"/>
											<?php
											endif;
											?>
										</div>
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control form_input1 validate[required]" id="code" name="code" placeholder="Type The Code Shown" value="<?php echo(isset($_POST['code']) && $_POST['code']!='' ? $_POST['code'] : (isset($gsa_data['code']) && $gsa_data['code']!='' ? $gsa_data['code'] : ""));?>" tabindex="21">
										</div>
										<div class="clearfix"></div>
										<div class="form-group col-md-6">
											<label for="website" class="form-label1">Your Payment Type :</label>
											<div class="radio">
											  <label class="form-label1"><input type="radio" name="payment_type" id="credit" <?php echo(isset($gsa_data['payment_type']) && $gsa_data['payment_type']=='credit' ? "checked" : "");?> value="credit">Credit</label>&nbsp;&nbsp;&nbsp;
											  <label><input type="radio" name="payment_type" id="cash" value="cash" <?php echo(isset($gsa_data['payment_type']) && $gsa_data['payment_type']=='cash' ? "checked" : "");?>>Cash</label>
											</div>
										</div>
										<div class="form-group col-md-6" id="pay_within_days" style="<?php echo(isset($gsa_data['payment_type']) && $gsa_data['payment_type']=='cash' ? "display:block;" : "display:none;");?>"">
											...
											?>
												<option value = "<?php echo $day_val;?>" <?php echo(isset($_POST['pay_within_days']) && $_POST['pay_within_days']==$day_val ? 'selected="selected"' : (isset($gsa_data['pay_within_days']) && $gsa_data['pay_within_days']==$day_val ? 'selected="selected"' : ""));?>><?php echo $day_val;?></option>
											<?php
											endforeach;
											?>
											</select>
								...
								<div class="box-body">
									<div id="" class="row rows">
										<div class="form-group col-md-12">
											...
											<input type="text" class="form-control form_input1 validate[required]" id="username" name="username" placeholder="Username" value="<?php echo(isset($_POST['username']) && $_POST['username']!='' ? $_POST['username'] : (isset($gsa_data['username']) && $gsa_data['username']!='' ? $gsa_data['username'] : ""));?>" tabindex="22">
										</div>
										<div class="form-group col-md-6">
