								...
								<div class="col-md-12 row">
									<div class="box-body">
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control validate[required, custom[onlyLetterNumber]]"  value="<?php echo(isset($_POST['attribute_name']) && $_POST['attribute_name']!='' ? $_POST['attribute_name'] : "");?>" name="attribute_name" id="attribute_name" placeholder="Transfer Type Title" tabindex = "1" />
										</div>
										<div class="form-group col-md-6">
