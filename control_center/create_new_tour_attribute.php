		...
		if($autentication_data->status=="success"):
			...
			if(isset($_POST['btn_submit'])) {
				if(tools::verify_token($white_list_array, $_POST, $verify_token)) {
					...
					curl_setopt($ch, CURLOPT_URL, DOMAIN_NAME_PATH.REST_API_PATH.TOUR_API_PATH."attribute/create.php");
...
<html>
<head>
	<title><?php echo(DEFAULT_PAGE_TITLE_CONTROL_CENTER);?>CREATE NEW TOUR ATTRIBUTE</title>
	<?php require_once(CONTROL_CENTER_COMMON_FILE_PATH.'meta.php');?>
	<!-- JAVASCRIPT CODE -->
	<script type="text/javascript">
	<!--
	$(function(){
		$("#new_tour_attributes_form").validationEngine();
	});
	//-->
	</script>
</head>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
            <section class="content-header">
               <h1>Create New Tour Attribute</h1>
               <ol class="breadcrumb">
                  <li><a href="<?php echo(DOMAIN_NAME_PATH_ADMIN);?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                  <li class="active">Create New Tour Attribute</li>
               </ol>
            </section>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="box box-primary">
							<form name="new_tour_attributes_form" id="new_tour_attributes_form" method="POST" enctype="multipart/form-data">
