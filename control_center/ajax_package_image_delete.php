...
require_once('loader.inc');
	...
	if(isset($_POST['package_id']) && $_POST['package_id']!="" && isset($_POST['image_name']) && $_POST['image_name']!=""):
		...
		if(isset($autentication_data->status)):
			if($autentication_data->status=="success"):
				...
				curl_setopt($ch, CURLOPT_URL, DOMAIN_NAME_PATH.REST_API_PATH.PACKAGE_API_PATH."package/image_delete.php");
