								...
								<div class="col-md-12 row">
									<div class="box-body">
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control validate[required, custom[onlyLetterNumber]]"  value="<?php echo(isset($_POST['title']) && $_POST['title']!='' ? $_POST['title'] : (isset($cost_data['title']) && $cost_data['title']!='' ? $cost_data['title'] : ""));?>" name="title" id="title" placeholder="Title" tabindex = "1" />
										</div>
										<div class="form-group col-md-6">
											<label for="Cost" class="control-label">Cost<font color="#FF0000">*</font></label>
											<input type="text" class="form-control validate[required, custom[number]]"  value="<?php echo(isset($_POST['cost']) && $_POST['cost']!='' ? $_POST['cost'] : (isset($cost_data['cost']) && $cost_data['cost']!='' ? $cost_data['cost'] : ""));?>" name="cost" id="cost" placeholder="Cost" tabindex = "2" />
										</div>
