...
<html lang="en">
	<head>
		...
		<script src="<?php echo(DOMAIN_NAME_PATH);?>raty/jquery.raty.js" type="text/javascript"></script>
		<script src="<?php echo(DOMAIN_NAME_PATH);?>js/bootstrap-toggle.min.js" type="text/javascript"></script>
		<link href="<?php echo(DOMAIN_NAME_PATH);?>css/clocks.css" type="text/css" rel="stylesheet">
		<link href="<?php echo(DOMAIN_NAME_PATH);?>css/bootstrap-toggle.css" type="text/css" rel="stylesheet">
		<style type="text/css">
		...
		$(function(){
			...
			$("#rooms").change(function(){
				...
				{
					adult_child_html+='<div class="row rows each_adult_child_div">';
		...
		function child_attribute(cur, index)
		{
			...
			if(val!='') 
			{
				for(var i=0;i<val;i++)
				{
					...
					child_number_html+='<div class="row rows each_child_age_div">';
		...
		function fetch_step2_rcd(page, type, sort_order='', city_id='', country_id='', search_val='')
		{
			$.ajax({
				...
				$(".rate_content_div").each(function(){
					$(this).raty({
						readOnly: true,
						path: '<?php echo(DOMAIN_NAME_PATH);?>raty/images',
				...
				$("a").each(function(){
					if($(this).attr("href"))
					{
						var new_href=$(this).attr("href").replace("control_center/", "");
	...
	<body class="index-page">
		<div class="loader_inner"><img src="img/spinner.gif" border="0" alt="Loading..."></div>
		<!-- TOP HEADER -->
									...
									<div class="wizard">
										...
										<div class="tab-content">
											<div class="tab-pane active" role="tabpanel" id="step1">
												<h3 style = "font-weight:bold;color:#1281c4;font-size: 20px !important;">Select Criteria For New Booking</h3>
														...
														<div class="col-md-12">
															...
															<div class="box-body" style = "border:1px solid #1281c4;padding: 5px; border-radius:10px;">
																...
																if(isset($_POST['rooms']) && $_POST['rooms']!="")
																{
																	...
																	{
																?>
																	<div class="row rows each_adult_child_div">
																		<div class="form-group col-md-3">
																		...
																		<?php
																			...
																			{
																		?>
																			<div class="row rows each_child_age_div">
																				<div class="form-group col-md-4">
											...
											<div class="tab-pane" role="tabpanel" id="step2">
												<h3 style = "font-weight:bold;color:#1281c4;font-size: 20px !important;">Search Hotels</h3>
											...
											<div class="tab-pane" role="tabpanel" id="step4">
												<h3 style = "font-weight:bold;color:#1281c4;font-size: 20px !important;">Search Transfers</h3>
											...
											<div class="tab-pane" role="tabpanel" id="step3">
												<h3 style = "font-weight:bold;color:#1281c4;font-size: 20px !important;">Search Tour</h3>
											...
											<div class="tab-pane" role="tabpanel" id="complete">
												<h3 style = "font-weight:bold;color:#1281c4;font-size: 20px !important;">Complete Your Booking</h3>
