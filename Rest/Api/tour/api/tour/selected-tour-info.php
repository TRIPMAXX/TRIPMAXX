		...
		if(isset($server_data['data']) && isset($server_data['data']['step_1']) && !empty($server_data['data']['step_1']) && isset($server_data['data']['step_3']) && !empty($server_data['data']['step_3'])):
			...
			foreach($server_data['data']['step_3'] as $offer_key=>$offer_val):
				...
				if($server_data['data']['city_val']==$explode_offer_data[0]):
					...
					$each_result['booking_start_date']=$server_data['data']['step_3_all']['tour_booking_tour_date_arr'][$offer_key];
					$each_result['booking_end_date']=$server_data['data']['step_3_all']['tour_booking_tour_date_arr'][$offer_key];
					$each_result['pickup_time']=$server_data['data']['step_3_all']['tour_pickuptime_arr'][$offer_key];
					$each_result['dropoff_time']=$server_data['data']['step_3_all']['tour_dropofftime_arr'][$offer_key];
