<?php
	...
	//$server_data=json_decode('{"token":{"token":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9..G5WycyqGAn7_dHPK9eVGm7yCUW18cu0UjodQDnB3ir-bQp8ngVjb93n0ziPWr6Vapd1aJGQPTI03gDQUOUuCkw","token_timeout":100,"token_generation_time":1524139854},"data":{"booking_type":"personal","agent_name":"","checkin":"19\/04\/2018","checkout":"22\/04\/2018","country":["101","101"],"city":["5312","5313"],"number_of_night":["2","2"],"hotel_ratings":[["2","3"],["2","3"]],"sel_nationality":"14","country_residance":"9","sel_currency":"1","rooms":"1","adult":["1"],"child":[""],"offset":0,"record_per_page":10,"type":"1","sort_order":"","city_id":"","country_id":"","search_val":""}}', true);
...
?>
								<div style="padding:10px 0 10px 0;border:1px solid gray;">
									<div class="col-md-1" style="font-weight:bold;">
										...
										?>
										<br>
										<input type="radio" name="selected_offer[<?= $server_data['data']['city'][$country_key];?>]" class="selected_offer" onclick="change_offer_radio($(this))" value="<?= $server_data['data']['city'][$country_key]."-".$offer_val['id'];?>">
									</div>
									...
									?>
									<?php echo $default_currency['currency_code'].number_format((($total_price+$agent_commision)*$total_person), 2,".",".");?>
									</div>
...
<?php
								...
								$each_first_price=$default_currency['currency_code'].number_format((($total_price+$agent_commision)*$total_person), 2,".",".");
							endforeach;
						endif;
						ob_start();
?>
...
<?php
				...
				if($server_data['data']['sort_order']=="" && $server_data['data']['type']!=3 && $server_data['data']['type']!=2):
					...
					$country_city_rcd_html.='<div class="col-md-6 heading_count_rcd">';
						...
						$country_city_rcd_html.='<p>Your search for <font color="red"><b>'.$country_name.'</b></font>, <font color="red"><b>'.$city_name.'</b></font> for <font color="red"><b>'.$total_person.' Passenger(s)</b></font> fetched <font color="red"><b><span class="total_tour_number">'.$heading_count_rcd.'</span> Tour(s)</b></font></p>';
					...
					$country_city_rcd_html.='<div class="col-md-6">';
						...
						$country_city_rcd_html.='<input type = "radio" name = "sort" value="name" onchange="change_order($(this))" data-city_id="'.$server_data['data']['city'][$country_key].'" data-country_id="'.$counrty_val.'"'.(isset($server_data['data']['sort_order']) && $server_data['data']['sort_order']=="name" ? 'checked="checked"' : '').'/>&nbsp;Tour Title&nbsp;&nbsp;';
					...
					$country_city_rcd_html.='<form name="form_third_step" id="form_third_step" method="POST" onsubmit="filter_search($(this), '.$server_data['data']['city'][$country_key].');return false;" data-country_id="'.$counrty_val.'">';
