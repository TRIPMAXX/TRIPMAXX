...
class tools { 
	...
	*/
	...
	public static function createThumbnail($filepath, $thumbpath, $thumbnail_width, $thumbnail_height, $background=false) {
		...
		$new_image = tools::image_create_transparent($thumbnail_width, $thumbnail_height); // creates new image, but with a black background
	...
	public static function image_create_transparent($width, $height) {
