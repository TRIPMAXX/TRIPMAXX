...
<html lang="en">
	<head>
		...
		<!--
			...
			{
				$.ajax({
					url:"<?= DOMAIN_NAME_PATH."ajax_agent_status_update";?>",
					type:"post",
					data:{
						agent_id:agent_id
					},
													...
													?>
														<tr class="odd">
															...
															<td class=" " data-title="Action">
																...
																<a href = "<?php echo(DOMAIN_NAME_PATH);?>edit_agent?agent_id=<?php echo base64_encode($agent_val['id']);?>&gse_id=<?php echo base64_encode($gsa_data['id']);?>" title = "Edit Agent"><i class="fa fa-pencil-square-o fa-1x" ></i></a>&nbsp;&nbsp;
																<!-- <a href = "<?php echo(DOMAIN_NAME_PATH);?>sub_agents?agent_id=<?php echo base64_encode($agent_val['id']);?>&gse_id=<?php echo base64_encode($gsa_data['id']);?>"  title = "Delete Agent" onclick = "confirm('Are you sure you want to delete this item?') ? '' : event.preventDefault()"><i class="fa fa fa-trash-o fa-1x"></i></a> -->
															</td>
														</tr>
													<?php
														endforeach;
